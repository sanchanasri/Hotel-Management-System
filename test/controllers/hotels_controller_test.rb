...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference("Hotel.count") do
      post hotels_url, params: { hotel: { contact_no: @hotel.contact_no, days: @hotel.days, location: @hotel.location, name: @hotel.name, times: @hotel.times } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { contact_no: @hotel.contact_no, days: @hotel.days, location: @hotel.location, name: @hotel.name, times: @hotel.times } }
